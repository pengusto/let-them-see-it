...
Los idiomas predeterminados del README son inglés, alemán, chino simplificado, japonés, español, coreano, portugués de Brasil y francés. El README en inglés permanece en la raíz; las traducciones usan `docs/readme/` salvo que el proyecto siga otra convención. Antes de editar, el skill enumera los idiomas y rutas previstos. Comprueba la coherencia de las traducciones y, cuando es posible, el inicio rápido desde un clon nuevo. También evalúa el desorden de la raíz según las rutas reales de ejecución, compilación, pruebas y empaquetado, sin imponer un árbol genérico. Adapta las propuestas al tipo de proyecto y aclara su estado de mantenimiento; una imagen de vista previa para redes sociales es opcional. Añade insignias, ejemplos de configuración, archivos de comunidad y CI cuando ayudan al proyecto. Publicar requiere autorización y es una acción distinta de preparar.
