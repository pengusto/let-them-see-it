...
该技能建议提供英语、德语和简体中文 README。只有在对项目有帮助时，才添加徽章、配置示例、社区文件和 CI。发布需要授权，与准备工作分开处理。
...
请提交包含实际行为和预期结果的 Issue，或范围明确的 Pull Request。保持三种语言的 README 内容一致。请勿在报告中包含凭据或私有仓库内容。
