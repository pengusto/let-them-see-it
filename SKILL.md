...
- Languages: propose English `README.md`, German `README.de.md`, Simplified Chinese `README.zh-CN.md`, and Japanese `README.ja.md` by default, with reciprocal language links and equivalent content. Respect existing locale conventions and user preferences. Keep code, commands, identifiers, and paths consistent; disclose machine translation when no fluent review was performed.
