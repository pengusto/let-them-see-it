...
- GitHub surfaces: evaluate Sponsors (`.github/FUNDING.yml`), Discussions, Releases, `CITATION.cff`, repository topics/description, social preview, and Insights traffic when relevant. Mark each as useful, unnecessary, or blocked by missing profile, audience, maintainer capacity, or project metadata. Do not create payment links, enable features, publish a release, or claim reach from a badge without explicit scope and evidence.
